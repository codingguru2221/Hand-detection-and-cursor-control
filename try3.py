    ...
    while True:
        ...
        if results.multi_hand_landmarks:
            for hand_landmarks in results.multi_hand_landmarks:
                # Extract coordinates from the wrist (index 0) and index fingertip (index 8)
                ...
                thumb_tip = (normalized_wrist_x, normalized_wrist_y)
                index_finger_tip = (normalized_index_finger_x, normalized_index_finger_y)
                detect_click(thumb_tip, index_finger_tip)
